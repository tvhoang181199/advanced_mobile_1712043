...
class _HomePage extends State<HomePage> {
  ...
  List<CourseModel> topSellCourses;
  List<CourseModel> topRateCourses;
  ...
  void _fetchData() async {
    ...
    // });
    //
    // trendingCourses = await APIServer().fetchTopNewCourses(5, 1);
    // topSellCourses = await APIServer().fetchTopNewCourses(10, 1);
    // topRateCourses = await APIServer().fetchTopNewCourses(10, 1);
    //
    // setState(() {
    //   _isLoading = false;
    // });
